...
variable "shared_acr_id" {
  description = "ARM ID of the shared platform ACR. The workload references but never owns it."
  type        = string
...
variable "container_image" {
  description = "Initial image. GitHub replaces this with an immutable digest after PLATFORM_READY."
  type        = string
  default     = "mcr.microsoft.com/azuredocs/containerapps-helloworld@sha256:e9b3e7c34664c7cffd7144864b0e4eec369bfde80068f9095dc63b37058bec48"
